...
namespace Tours.NET.WinForms
{
  public partial class MainForm : Form
  {
    ...
    private void MainForm_Load(object sender, EventArgs e)
    {
      ...
      dataGridViewTips.DataSource = Tours.Biz.Tips.Current.GetTips();
      dataGridViewTestimonials.DataSource = Tours.Biz.Testimonials.Current.GetTestimonials();
      listBox1.DataSource = Tours.Biz.Tours.Current.GetTours();
